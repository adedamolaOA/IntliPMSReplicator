...
public class PropertyAreas implements Serializable {
    ...
    private Collection<Propertyschmaint> propertyschmaintCollection;
    ...
    @XmlTransient
    public Collection<Propertyschmaint> getPropertyschmaintCollection() {
        return propertyschmaintCollection;
    }

    public void setPropertyschmaintCollection(Collection<Propertyschmaint> propertyschmaintCollection) {
        this.propertyschmaintCollection = propertyschmaintCollection;
    }
    ...
    public String toString() {
        return "com.intlipms.entities.PropertyAreas[ areaid=" + areaid + " ]";
    }
